...
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_AOP_STAT_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_WEB_STAT_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidDataSourceProperties.DruidAopStatProperties;
import static com.github.trang.autoconfigure.druid.properties.DruidDataSourceProperties.DruidWebStatProperties;
...
class DruidStatConfiguration {
    ...
    public static class DruidAopStatConfiguration {
        ...
        public DefaultAdvisorAutoProxyCreator druidStatProxy() {
            logger.info("druid aop-stat init...");
    ...
    public static class DruidWebStatConfiguration {
        ...
        public FilterRegistrationBean druidWebStatFilter(DruidDataSourceProperties druidProperties) {
            logger.info("druid web-stat-filter init...");
