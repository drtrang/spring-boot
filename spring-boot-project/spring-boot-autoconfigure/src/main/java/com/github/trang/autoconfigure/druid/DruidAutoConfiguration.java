...
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_COMMONS_LOG_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_CONFIG_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_ENCODING_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_LOG4J2_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_LOG4J_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_SLF4J_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_STAT_FILTER_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_WALL_CONFIG_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_WALL_FILTER_PREFIX;
...
import com.github.trang.autoconfigure.druid.properties.DruidDataSourceProperties;
...
public class DruidAutoConfiguration {
    ...
    public StatFilter statFilter() {
        logger.debug("druid stat-filter init...");
    ...
    public WallFilter wallFilter(WallConfig wallConfig) {
        logger.debug("druid wall-filter init...");
    ...
    public ConfigFilter configFilter() {
        logger.debug("druid config-filter init...");
    ...
    public Slf4jLogFilter slf4jLogFilter() {
        logger.debug("druid slf4j-filter init...");
    ...
    public Log4jFilter log4jFilter() {
        logger.debug("druid log4j-filter init...");
    ...
    public Log4j2Filter log4j2Filter() {
        logger.debug("druid log4j2-filter init...");
    ...
    public CommonsLogFilter commonsLogFilter() {
        logger.debug("druid commons-log-filter init...");
    ...
    public EncodingConvertFilter encodingConvertFilter() {
        logger.debug("druid encoding-convert-filter init...");
