...
import static com.github.trang.autoconfigure.druid.properties.DruidConstants.DRUID_STAT_VIEW_SERVLET_PREFIX;
import static com.github.trang.autoconfigure.druid.properties.DruidDataSourceProperties.DruidStatViewServletProperties;
...
class DruidServletConfiguration {
    ...
    public ServletRegistrationBean druidStatViewServlet(DruidDataSourceProperties druidProperties) {
        logger.info("druid stat-view-servlet init...");
