...
import com.github.trang.autoconfigure.redisson.RedissonSpringProperties.RedissonCacheManagerProperties;
import com.github.trang.autoconfigure.redisson.enums.CodecType;
...
public class RedissonSpringAutoConfiguration {
    ...
    private final ObjectProvider<List<BeanCustomizer<RedissonSpringCacheManager>>> redissonSpringCacheManagerCustomizers;
    ...
    public RedissonSpringCacheManager redissonSpringCacheManager(RedissonClient redisson) {
        ...
        redissonSpringCacheManagerCustomizers.getIfAvailable(Collections::emptyList)
