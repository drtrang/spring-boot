package com.github.trang.autoconfigure.druid.datasource.init;
...
import com.github.trang.autoconfigure.druid.DruidDataSourceInitializerAutoConfiguration;
    ...
    private DataSourceInitializer getDataSourceInitializer() {
        if (this.dataSourceInitializer == null) {
            ...
            if (!dataSources.isEmpty()) {
                this.dataSourceInitializer = new DataSourceInitializer(dataSources,
